...
def process_html_files():
    for file_name in os.listdir(input_directory):
        ...
        token_output_path = os.path.join(output_directory, f"tokens_{base_name}.txt")
        lemma_output_path = os.path.join(output_directory, f"lemmas_{base_name}.txt")
